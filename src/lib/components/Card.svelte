...
<!--Card article-->
  ...
  <article class="w-[550px] lg:bg-red-300 bg-contain  bg-cover text-xl text-center border-solid scale-75 m-auto rounded-[5%] p-8 hover:bg-orange-400 active:bg-teal-500 transition ease-linear duration-150">
   <div>
    <a href={url}>
